      ...
      <div class="card">
        ...
        <div class="card-body">
          <form class="form-horizontal" action="controller/doSystem.php" method="POST">
           ...
           <div class="form-group">
              <label for="title" class="col-xs-12">是否使用自定义首页模板：</label>
              <div class="col-xs-12">
                  <select name="zdy" class="form-control">
                     <option value="1"  <?php if($result[7]=='1'){echo "selected";} ?>  >是</option>
                     <option value="0"  <?php if($result[7]=='0'){echo "selected";} ?>  >否</option>
                </select>
              </div>
            </div>
            <div class="form-group">
