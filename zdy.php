    ...
    <div class="navall">
      ...
      function is_repeat_num($num)
     {
        ...
        if (strpos($num,'电信')!== false) {
            ...
            $res = file_get_contents("http://wap.kaboshihaoka.com/api/goodsList?agent_id=8941&operator=dx");
            return $res;
        }

         if (strpos($num,'移动')!== false) {
            $res = file_get_contents("http://wap.kaboshihaoka.com/api/goodsList?agent_id=8941&operator=yd");
            return $res;
        }

         if (strpos($num,'联通')!== false) {
            $res = file_get_contents("http://wap.kaboshihaoka.com/api/goodsList?agent_id=8941&operator=lt");
            return $res;
        }
        
         $res = file_get_contents("http://wap.kaboshihaoka.com/api/goodsList?agent_id=8941&operator=");
         return $res;   
    }
      ...
      foreach($arr['data']['data'] as $feature)  {
             ...
             $html= base64_decode ("");
